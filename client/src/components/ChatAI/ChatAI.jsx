          ...
          {isChatOpen && (
            <>
              <div className="flex justify-between items-center p-2 border-b">
                <h2 className="text-lg font-bold w-36" style={{ color: '#D97706' }}>FuHub AI</h2>
                <button
                  className="hover:text-gray-700 text-right text-2xl"
                  style={{ color: '#6B7280' }}
              ...
              >
                <input
                  type="text"
                  required
                  className="border rounded w-full min-h-fit p-2 transition-all duration-300 focus:shadow-lg focus:outline-primary"
